...
urlpatterns = [
    ...
    path('persona_detail/<int:persona_id>/', check_recaptcha(views.persona_detail), name='persona_detail'),
    path('persona_detail/qr/<int:persona_code>/', check_recaptcha(views.persona_detail), name='persona_qr_detail'),
